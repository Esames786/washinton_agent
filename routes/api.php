...
// Public: active campaigns/jobs for the CrazyRays application form (filter by employment_type)
Route::get('/campaigns', 'CrCampaignController@publicList')->middleware(['crazyrays.cors', 'throttle:60,1']);
