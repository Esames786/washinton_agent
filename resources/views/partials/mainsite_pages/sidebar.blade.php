<style>
    ...
    .mobile-sidebar-toggle {
        ...
        top: 50%;
        left: 0; /* fixed on the edge of the screen */
    ...
    <div class="app-sidebar__logo">
        <a class="header-brand" href="@if (Auth::user()->role != 6) {{ url('dashboard') }} @endif">
            ...
            <img src="{{ url(($brand['logo'] ?? 'frontend/img/logo/hello_transport.svg')) }}" class="header-brand-img dark-logo"
                alt="DayDispatch logo">
            <img src="{{ url(($brand['logo'] ?? 'frontend/img/logo/hello_transport.svg')) }}" class="header-brand-img mobile-logo"
                alt="DayDispatch logo" style="border: 1px solid deepskyblue; border-radius: 100px;">
            <img src="{{ url(($brand['logo'] ?? 'frontend/img/logo/hello_transport.svg')) }}" class="header-brand-img darkmobile-logo"
                alt="DayDispatch logo" style="border: 1px solid deepskyblue; border-radius: 100px;">
    ...
    @if (Auth::user()->role < 6 || Auth::user()->role > 7)
        ...
        <div class="">
            <ul class="side_nav_style" id="style-14">
                ...
                @if (in_array('170', $phoneaccess) || (Auth::user()->role ?? 0) == 1 || (optional(Auth::user()->userRole)->name ?? '') == 'Manager')
                    <li>
                        <a class="side-menu__item" href="{{ url('carrier_update_approval') }}">
                            ...
                            <span class="side-menu__label">CARRIER UPDATE APPROVAL</span><span class="badge badge-warning side-badge" id="cua_folder_count"
                ...
                @endif
                @if (in_array('52', $phoneaccess) || Auth::user()->userRole->name == 'Admin')
                    <li>
                ...
                {{-- Hidden per request: Subcontractor Revenue (OT/DB/DIS/Private OT)
                    ...
                    <li>
                        <a style="background: #2dd1ba8c" class="side-menu__item"
                           href="{{ route('autos.autos_approach_new_carrier') }}">
                            <span class="js-search-result-thumbnail responsive-img img_border fa fa-mobile"></span>
                            <span class="side-menu__label">Carrier Approaching</span>
                            <span class="badge badge-warning side-badge" style="font-size: 15px"></span>
                        </a>
                    </li>
                @endif
