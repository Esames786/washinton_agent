...
<script src="{{ asset_v('assets/js/jquery-cookie.js') }}"></script>
<!-- Bootstrap4 js-->
...
<script src="{{ asset_v('assets/plugins/notify/js/rainbow.js') }}"></script>
<script src="{{ url('assets/plugins/notify/js/sample.js') }}?id=1"></script>
<script src="{{ asset_v('assets/plugins/notify/js/jquery.growl.js') }}"></script>
<script src="{{ asset_v('assets/plugins/notify/js/notifIt.js') }}"></script>
...
@if (Route::is('chats'))
    <!-- INTERNAL Chat js-->
    <script src="{{ asset_v('assets/js/chat.js') }}"></script>
@endif


<!-- INTERNAL Data tables -->
<script src="{{ asset_v('assets/plugins/datatable/js/jquery.dataTables.js') }}"></script>
<script src="{{ asset_v('assets/plugins/datatable/js/dataTables.bootstrap4.js') }}"></script>
<script src="{{ asset_v('assets/plugins/datatable/js/dataTables.buttons.min.js') }}"></script>
<script src="{{ asset_v('assets/plugins/datatable/js/buttons.bootstrap4.min.js') }}"></script>
<script src="{{ asset_v('assets/plugins/datatable/js/jszip.min.js') }}"></script>
<script src="{{ asset_v('assets/plugins/datatable/js/pdfmake.min.js') }}"></script>
<script src="{{ asset_v('assets/plugins/datatable/js/vfs_fonts.js') }}"></script>
<script src="{{ asset_v('assets/plugins/datatable/js/buttons.html5.min.js') }}"></script>
<script src="{{ asset_v('assets/plugins/datatable/js/buttons.print.min.js') }}"></script>
<script src="{{ asset_v('assets/plugins/datatable/js/buttons.colVis.min.js') }}"></script>
<script src="{{ asset_v('assets/plugins/datatable/dataTables.responsive.min.js') }}"></script>
<script src="{{ asset_v('assets/plugins/datatable/responsive.bootstrap4.min.js') }}"></script>
<script src="{{ asset_v('assets/js/datatables.js') }}"></script>
...
<script src="{{ asset_v('assets/plugins/time-picker/jquery.timepicker.js') }}"></script>
<script src="{{ asset_v('assets/plugins/time-picker/toggles.min.js') }}"></script>

<!-- INTERNAL Datepicker js -->
<script src="{{ asset_v('assets/plugins/date-picker/date-picker.js') }}"></script>
<script src="{{ asset_v('assets/plugins/date-picker/jquery-ui.js') }}"></script>
<script src="{{ asset_v('assets/plugins/input-mask/jquery.maskedinput.js') }}"></script>

<!-- INTERNAL File-Uploads Js-->
<script src="{{ asset_v('assets/plugins/fancyuploder/jquery.ui.widget.js') }}"></script>
<script src="{{ asset_v('assets/plugins/fancyuploder/jquery.fileupload.js') }}"></script>
<script src="{{ asset_v('assets/plugins/fancyuploder/jquery.iframe-transport.js') }}"></script>
<script src="{{ asset_v('assets/plugins/fancyuploder/jquery.fancy-fileupload.js') }}"></script>
<script src="{{ asset_v('assets/plugins/fancyuploder/fancy-uploader.js') }}"></script>

<!-- INTERNAL File uploads js -->
<script src="{{ asset_v('assets/plugins/fileupload/js/dropify.js') }}"></script>
<script src="{{ asset_v('assets/js/filupload.js') }}"></script>

<!-- INTERNAL Multipleselect js -->
<script src="{{ asset_v('assets/plugins/multipleselect/multiple-select.js') }}"></script>
<script src="{{ asset_v('assets/plugins/multipleselect/multi-select.js') }}"></script>

<!--INTERNAL Sumoselect js-->
<script src="{{ asset_v('assets/plugins/sumoselect/jquery.sumoselect.js') }}"></script>

<!--INTERNAL telephoneinput js-->
<script src="{{ asset_v('assets/plugins/telephoneinput/telephoneinput.js') }}"></script>
<script src="{{ asset_v('assets/plugins/telephoneinput/inttelephoneinput.js') }}"></script>

<!--INTERNAL jquery transfer js-->
<script src="{{ asset_v('assets/plugins/jQuerytransfer/jquery.transfer.js') }}"></script>

<!--INTERNAL multi js-->
<script src="{{ asset_v('assets/plugins/multi/multi.min.js') }}"></script>

<!--INTERNAL Form Advanced Element -->
<script src="{{ asset_v('assets/js/formelementadvnced.js') }}"></script>
<script src="{{ asset_v('assets/js/form-elements.js') }}"></script>
<script src="{{ asset_v('assets/js/file-upload.js') }}"></script>
<!-- Simplebar JS -->
