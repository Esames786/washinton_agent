        ...
        <div class="d-flex" style="align-items:center;">
            ...
            @if(Auth::user()->role < 6 || Auth::user()->role > 7)
             ...
             <ul class="header_social m-0 ml-2">
                ...
                <div class="header_ri">
                    {{-- R-Dialer: shown ONLY to users with dialer access (169 / admin) via the @if above;
                         a real visible icon (old hidden <button> left an invisible-but-clickable area). --}}
    ...
    $(function () {
        ...
        function fetchNavCounts() {
            $.getJSON("{{ route('nav.counts') }}", function (d) {
                ...
                $('#cr_app_count').text(cr).css('display', cr > 0 ? 'flex' : 'none'); // show the real number, not 99+
