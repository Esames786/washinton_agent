                                ...
                                <div class="col-sm-12 add_phone">
                                    <div class='row'>&nbsp;&nbsp;&nbsp;
                                        ...
                                        <div class="form-group col-11 ">
                                            <input type="text" onchange="getOldData()" name="ophone[]" id="ophone" autocomplete="off" class="form-control this_save  ophone ophone_new" required onkeypress="$(this).css('border-color', 'rgb(92 166 242)');" placeholder="Number" value="{{ $phoneno }}">
                                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                                ...
                                <select  multiple data-placeholder="Trailer Specification" id="trailer_specification" name="trailer_specification[]"  class="form-control select2 trailer_specification this_save" >
                    ...
                    <div class="row mb-3">
                        <div class="col-md-3">
                            ...
                            <div class="input-container">
                                <input type="number" name="length_ft[]" id="length_ft" class="input-field" placeholder=""
                                    min="0" maxlength="3" oninput="limitDigits(this, 3)">
                                <span class="separator">(Ft.)</span>
                                <input type="number" name="length_in[]" id="length_in" class="input-field" placeholder=""
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-container">
                                <input type="number" name="width_ft[]" id="width_ft" class="input-field" placeholder=""
                                    min="0" maxlength="3" oninput="limitDigits(this, 3)">
                                <span class="separator">(Ft.)</span>
                                <input type="number" name="width_in[]" id="width_in" class="input-field" placeholder=""
                                    min="0" max="11" maxlength="2" oninput="limitDigits(this, 2)">
                                <span class="separators">(In.)</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-container">
                                <input type="number" name="height_ft[]" id="height_ft" class="input-field" placeholder=""
                                    min="0" maxlength="3" oninput="limitDigits(this, 3)">
                                <span class="separator">(Ft.)</span>
                                <input type="number" name="height_in[]" id="height_in" class="input-field" placeholder=""
                                    min="0" max="11" maxlength="2" oninput="limitDigits(this, 2)">
                                <span class="separators">(In.)</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-container1">
                                <input type="" id="weight" class="input-field-1" placeholder=""
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#checkPrice').click(function() {
            ...
            var o_zip1 = $('#o_zip1').val();
            var d_zip1 = $('#d_zip1').val();
            var trailer_specification = $('#trailer_specification').val();
            ...
            if (o_zip1 === "" || d_zip1 === "" || trailer_specification === "" || length_ft === "" || length_in === "" || width_ft === "" || width_in === "" || height_ft === "" || height_in === "" || weight === "") {
                $('#modalMessage').html(
                    '<div class="alert alert-warning" role="alert">' +
                    '<strong>Please fill Origin?destination zipcodes, and Freight Information.</strong>' +
                    '</div>'
                );
