...
@section('content')
    ...
    <div class="page-header">
        ...
        <div class="text-secondary text-center text-uppercase w-100">
            <h1 class="my-4"><b>Autos Approach Carrier Report</b></h1>
        </div>
    </div>
    <!--End Page header-->
    <!-- Row -->
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                    ...
                    <div class="card-header">
                        <div class="container-fluid">
                            <div class="col-lg-12 p-0">
                                    <?php
                                    $datas = \App\ShipperDetailsCarrier::select('states', 'id')->where('states', '!=', '-')->groupBy('states')->orderBy('states', 'asc')->get();
                                    ...
                                    $company = \App\ShipperDetailsCarrier::with('user')->has('user')->get();
                ...
                <div class="card-body">
                    <div id="table_data">
                        @include('main.phone_quote.assignedNewAutoApprochingCarrier.table')
                    </div>
                </div>
            </div>
        </div>
