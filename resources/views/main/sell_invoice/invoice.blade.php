                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-5 my-auto">
                            <img src="{{ url(($brand['logo'] ?? 'frontend/img/logo/hello_transport.svg'))}}" class="w-50" alt="Ship A1" />
                        </div>
                        <div class="col-sm-7">
                ...
                <div class="col-sm-12 mt-4">
                    <div class="row">
                        <div class="col-sm-5">
                            ...
                            <br><br>
                            <small class="text-muted">Email: {{ $brand['contact_email'] ?? 'info@hellotransport.com' }}</small>
                        </div>
                        <div class="col-sm-7">
                            <div class="row mt-3">
                                <div class="col-sm-12">
