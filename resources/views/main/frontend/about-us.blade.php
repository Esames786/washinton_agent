...
<section class="page-title-area pt-100 pb-100"
         style="background-image:url({{ asset('frontend/img/banner/13.png') }});">
    <div class="container">
...
<section class="about-us-area pt-100 pb-70">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="about-img">
                    <img src="{{ asset('frontend/img/about/about-3-1.webp') }}" decoding="async"
                         width="100%" height="100%" loading="lazy" alt="About Hello Transport">
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="about-img">
                    <img src="{{ asset('frontend/img/banner/11.jpg') }}" decoding="async" width="100%"
                         height="100%" loading="lazy" alt="Our Mission">
                </div>
            </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="about-content">
                    ...
                    <a href="{{ route('Frontend.contact.us') }}" class="default-btn mt-3">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="about-content">
                    ...
                    <p>
                        <strong>Email:</strong> <a href="mailto:hodontime@shipa1.com">hodontime@shipa1.com</a>
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="about-img">
                    <img src="{{ asset('frontend/img/banner/8.png') }}" decoding="async" width="100%"
                         height="100%" loading="lazy" alt="Our Vision">
                </div>
            </div>
