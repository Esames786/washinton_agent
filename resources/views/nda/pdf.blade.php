...
{{-- The exact NDA copy the agent signed (admin-prepared rich text, or the branded default). --}}
<div class="nda-body">
    {!! $ndaContent !!}
</div>
...
<div class="sign-block">
    <div class="label">Employee Acknowledgment &amp; Signature</div>
    <div class="sign-row"><span class="field-label">Employee Name:</span> <span class="field-value">{{ $employeeName }}</span></div>
