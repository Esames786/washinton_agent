      ...
      ">
        ...
        <ul style="list-style-type: none; padding: 0;">
            <li style="margin: 5px 0;">
                Name: <span>{{ isset($order->oname) ? $order->oname : '' }}</span>
            </li>
            <li style="margin: 5px 0;">
                Phone:
            ...
            @if (isset($order->car_type) && $order->car_type == 1)
                    <?php
                    $ymk = [];
                    if (isset($order->ymk)) {
                ...
                @if (isset($order->transport))
                    <li style="margin: 5px 0;">
                        <b>Trailer Type:</b> <span>{{ $order->transport == '1' ? 'Open' : 'Enclosed' }}</span>
                    </li>
                @endif
            @elseif (isset($order->car_type) && $order->car_type == 2)
                @if (isset($order->equip))
                    <li style="margin: 5px 0;">
            ...
            @endif
                ...
                <?php
                $eqType = [];
                if (isset($order->freight->equipment_type)) {
            ...
            @if (isset($order->originzsc))
                <li style="margin: 5px 0;">
                    <strong>Origin:</strong> <span>{{ $order->originzsc }}</span>
                </li>
            @endif

            @if (isset($order->destinationzsc))
                <li style="margin: 5px 0;">
        ...
        @if (isset($order->payment))
          ...
          ">
            ...
            <p style="font-size: 18px">
                ...
                <span style="font-weight: bold">$<span>{{ $order->payment }}</span></span>
            </p>
        @endif
