      ...
      <tr>
        <td style="padding:36px 40px;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
            <tr>
              <td style="background:#f0fdfa;border:1px solid #99f6e4;border-radius:8px;padding:20px 24px;">
                ...
                @php
                    // Per-PERSON brand URL: Hello staff → hr.hellotransport.com, CrazyRays staff →
                    // hr.crazyrayssolutions.com.pk — never the sending deployment's own HR.
                    $__hrUrl = $hrLoginUrl ?? (rtrim(config('bridge.hrportal.base_url'), '/') . '/subcontractor/login');
                @endphp
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
            <tr>
              <td align="center">
                <a href="{{ $__hrUrl ?? (rtrim(config('bridge.hrportal.base_url'), '/') . '/subcontractor/login') }}"
