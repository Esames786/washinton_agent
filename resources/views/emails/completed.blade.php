...
@section('content')
    <div class="content">
        ...
        <p>
            ...
            Email: <a href="mailto:{{ $brand['contact_email'] ?? 'info@hellotransport.com' }}"
                style="color: #0056b3; text-decoration: none;">{{ $brand['contact_email'] ?? 'info@hellotransport.com' }}</a><br />
