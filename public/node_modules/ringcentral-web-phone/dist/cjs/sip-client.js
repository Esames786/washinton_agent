...
class DefaultSipClient extends event_emitter_js_1.default {
    ...
    async register(expires) {
        ...
        const requestMessage = new request_js_1.default(`REGISTER sip:${this.sipInfo.domain} SIP/2.0`, {
            ...
            Contact: `<sip:${utils_1.fakeEmail};transport=wss>;+sip.instance="<urn:uuid:${this.instanceId}>";expires=${expires}`,
            From: `<sip:${this.sipInfo.username}@${this.sipInfo.domain}>;tag=${(0, utils_1.uuid)()}`,
            To: `<sip:${this.sipInfo.username}@${this.sipInfo.domain}>`,
            Via: `SIP/2.0/WSS ${utils_1.fakeDomain};branch=${(0, utils_1.branch)()}`,
        });
